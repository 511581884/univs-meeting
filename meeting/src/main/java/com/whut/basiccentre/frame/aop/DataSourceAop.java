...
import com.whut.basiccentre.frame.annotation.DataSourceSwitch;
import com.whut.basiccentre.frame.db.DataSourceContextHolder;
...
public class DataSourceAop implements PriorityOrdered {
    ...
    @Pointcut("@annotation(com.whut.basiccentre.frame.annotation.DataSourceSwitch)")
    ...
    /**
     * 清除数据源一方面为了避免内存泄漏，更重要的是避免对后续在本线程上执行的操作产生影响
     */
