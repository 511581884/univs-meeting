...
import com.whut.basiccentre.frame.annotation.CacheData;
import com.whut.basiccentre.frame.utils.GsonUtils;
import com.whut.basiccentre.frame.utils.StringUtils;
import com.whut.basiccentre.frame.utils.md5.Md5;
...
public class CacheAspect {
    ...
    @Pointcut("@annotation(com.whut.basiccentre.frame.annotation.CacheData)")
    public void cache() {
    }
    ...
    private String generateKey(ProceedingJoinPoint point) {
        ...
        return String.format("basiccentre:%s:%s:%s", declaringTypeName, name, argsMd5);
    }
